...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    fetch(`https://juju.rf.gd/backend/parking_app/get_profile.php?user_id=${userId}`)
  ...
  const handleValidate = async () => {
    try {
      ...
      const res = await fetch("https://juju.rf.gd/backend/parking_app/update_profile.php", {
        method: "POST",
